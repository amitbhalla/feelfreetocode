...
from chapter.models import Chapter, TextChapter, HeadingChapter, VideoChapter, LinkChapter, chapter_choices, chapter_choises_description, video_platform_choises
from chapter.serializers import ChapterSerializer, TextChapterSerializer, HeadingChapterSerializer, VideoChapterSerializer, LinkChapterSerializer
